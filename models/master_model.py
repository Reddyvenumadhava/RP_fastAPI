...
class MasterSalutation(Base):
    ...
    __tablename__ = "tbl_cd_msalutation"
...
class MasterLanguage(Base):
    ...
    __tablename__ = "tbl_cd_mlanguages"
...
class MasterInterest(Base):
    ...
    __tablename__ = "tbl_cd_minterests"
...
class MasterCollege(Base):
    ...
    __tablename__ = "tbl_cd_companies"
...
class MasterCertification(Base):
    ...
    __tablename__ = "tbl_cd_certifications"
...
class MasterCountry(Base):
    ...
    __tablename__ = "tbl_cd_mcountries"
...
class MasterPincode(Base):
    ...
    __tablename__ = "tbl_cd_mpincodes"
...
class ResumeHash(Base):
    ...
    __tablename__ = "tbl_cd_resume_hashes"
