...
try:
    ...
    missing_tables = {
        ...
        # Address (3 tables)
        'tbl_cd_student_address',
        'tbl_cd_college_address',
        'tbl_cd_company_address',
        
        # Round Configuration (2 tables)
        'tbl_cd_jd_round_config',
        'tbl_cd_m2m_jd_round_module',
        ...
        'tbl_cd_application_status_history',
        
        # Exam Session (2 tables)
        'tbl_cd_exam_session',
        'tbl_cd_m2m_exam_question_response',
        
        # Interview Session (3 tables)
        'tbl_cd_interview_session',
        'tbl_cd_m2m_session_module_score',
